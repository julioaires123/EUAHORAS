...
function timeCountDown() {
  ...
  // Subtraindo 20 segundos e adicionando 8 segundos no cálculo dos segundos finais
  totalSeconds -= 20;
  ...
  // Incrementando 8 segundos no valor calculado
  const Segundos = (Math.floor(totalSeconds) + 40) % 60;
